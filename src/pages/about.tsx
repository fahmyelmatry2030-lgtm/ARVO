...
export default function About() {
    ...
    const milestones = [
        { year: '2020', title: 'البداية', description: 'انطلاق الرؤية في قلب الرياض لنعيد تعريف الفخامة.' },
        { year: '2022', title: 'الانتشار', description: 'وصول تصاميمنا لنخبة المجتمع في دول الخليج.' },
        { year: '2024', title: 'العالمية', description: 'عقد شراكات مع دور أزياء إيطالية لتطوير خاماتنا.' }
    ]
    ...
    return (
        <Layout>
            <SEO
                ...
                description="تعرف على الإرث والقصة وراء براند الملابس. نسيج من الجودة، الفن، والشغف بالتميز."
            />
                    ...
                    <div className="grid lg:grid-cols-2 gap-24 items-center mb-40">
                        ...
                        >
                            ...
                            <p className="text-gray-500 text-lg font-bold leading-loose max-w-xl italic">
                                "لم نكن نبحث عن مجرد قماش، بل كنا نبحث عن الروح التي تسكن بين ثناياه. في عام 2020، قررنا أن نكسر القاعدة ونقدم للرجل الخليجي قطعاً تحاكي طموحه وتليق بمقامه."
                            </p>
